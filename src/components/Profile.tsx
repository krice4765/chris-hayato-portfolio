  ...
  return (
    <section className="section-container" aria-labelledby="profile-title">
      <div className="mx-auto">
        ...
        {/* Main Profile Card */}
        <div className="relative bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-800/95 dark:via-gray-900/95 dark:to-gray-800/95 rounded-2xl p-6 md:p-8 mb-8 shadow-2xl border border-purple-100/50 dark:border-gray-700/50 overflow-hidden transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]">
          ...
          <div className="relative space-y-4 leading-relaxed text-lg md:text-xl font-semibold">
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>小学校から中学校まで野球に打ち込み、高校からは陸上部でやり投げに専念。</p>
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>音楽やプログラミング、ゲームが趣味です！</p>
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>普通科高校を卒業し、ITエンジニアとして約3.6年従事。</p>
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>彼女との交際を機に自分の将来と向き合い、自分で稼ぐ力を身につけるため、動画編集を始めました。</p>
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>現在はビジネス系やエンタメ系、Vlog系の編集経験があります。</p>
            <p style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>ショート動画の制作を通して様々なジャンルの編集に携わっていきたいと考えています。</p>
            <p
              className="font-extrabold text-xl mt-6 p-4 rounded-lg border-l-4"
              style={{
        ...
        {/* Basic Info Card */}
        <div className="relative bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 dark:from-gray-800/95 dark:via-gray-900/95 dark:to-gray-800/95 rounded-2xl p-6 md:p-8 mb-8 shadow-2xl border border-purple-100/50 dark:border-gray-700/50 overflow-hidden transition-all duration-500 hover:shadow-3xl hover:scale-[1.01]" role="region" aria-labelledby="basic-info-title">
          ...
          <div className="space-y-6 font-semibold">
            <div>
              <h4 className="font-extrabold text-2xl mb-2" style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>稼働日数：週4〜6日程度（週60時間以上）</h4>
            </div>
            <div>
              <h4 className="font-extrabold text-2xl mb-2" style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>稼働時間：9:00〜21:00</h4>
            </div>
            <div>
              <h4 className="font-extrabold text-2xl mb-2" style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>使用ソフト：Premiere Pro / Photoshop</h4>
            </div>
            <div>
              <h4 className="font-extrabold text-2xl mb-2" style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>使用PC：</h4>
              <ul className="space-y-2 ml-4 text-xl">
                <li className="flex items-start gap-3">
                  <span className="font-extrabold" style={{ color: theme === 'dark' ? '#a78bfa' : '#9333ea' }}>•</span>
                  <span style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>AMD Ryzen 9 7950X3D（16コア）</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="font-extrabold" style={{ color: theme === 'dark' ? '#a78bfa' : '#9333ea' }}>•</span>
                  <span style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>メモリ 64GB</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="font-extrabold" style={{ color: theme === 'dark' ? '#a78bfa' : '#9333ea' }}>•</span>
                  <span style={{ color: theme === 'dark' ? '#a78bfa' : '#1f2937' }}>ストレージ 1.38TB</span>
                </li>
              </ul>
            </div>
          </div>
